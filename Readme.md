...
- Intuos 3 tablets: Automatic method is currently unavailable, please use the manual method below instead
...
or `TabletDriver` entries you see in the list. Do the same on the Input Monitoring page.
...
`ConsumerTouchDriver`, and/or `WacomTouchDriver` in the list, select them, and click the minus button to remove them. 
Go to the Input Monitoring page and do the same there.
